...
/* harmony import */ var _mui_icons_material__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(17332);
/* harmony import */ var _mui_icons_material__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(34485);
/* harmony import */ var _mui_icons_material__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(17809);
/* harmony import */ var _mui_icons_material__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(55002);
/* harmony import */ var _mui_icons_material__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(62430);
...
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(13561);
/* harmony import */ var _features_auth_authSlice__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(32005);
/* harmony import */ var _component_NetworkLogoutIcon__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(40301);
...
/* harmony import */ var _component_MobileCardList__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(353);
...
function MaintenanceOrderAdmin() {
  ...
  var dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_45__/* .useDispatch */ .wA)();
  var user = (0,react_redux__WEBPACK_IMPORTED_MODULE_45__/* .useSelector */ .d4)(_features_auth_authSlice__WEBPACK_IMPORTED_MODULE_46__/* .selectCurrentUser */ .xu);
      ...
      var _ref9 = _asyncToGenerator(function* () {
        if (storesUserId) {
          try {
            ...
            dispatch((0,_features_auth_authSlice__WEBPACK_IMPORTED_MODULE_46__/* .setUser */ .gV)({
              userName: Name,
              role: Role,
  ...
  var MaintenanceInfoC = grantAccess.filter(row => row.moduleName === "Maintenance-Order" && row.access.createM === true);
  var MaintenanceInfoV = grantAccess.filter(row => row.moduleName === "Maintenance-Order" && row.access.readM === true);
  var MaintenanceInfoU = grantAccess.filter(row => row.moduleName === "Maintenance-Order" && row.access.readM === true);
  var MaintenanceInfoD = grantAccess.filter(row => row.moduleName === "Maintenance-Order" && row.access.deleteM === true);
  var handleLogout = () => {
    localStorage.removeItem('user');
    dispatch((0,_features_auth_authSlice__WEBPACK_IMPORTED_MODULE_46__/* .logOut */ .je)());
    navigate('/');
  };
  ...
  var fetchItems = /*#__PURE__*/function () {
    var _ref1 = _asyncToGenerator(function* (page, searchTerm, filterField, filterValue, statusFilter) {
      try {
        ...
        var isOffice = (user === null || user === void 0 || (_user$data = user.data) === null || _user$data === void 0 ? void 0 : _user$data.role) === 'CEO' || hasMainMaintenance;
        var statusParam = statusFilter && statusFilter !== 'ALL' ? "&status=".concat(encodeURIComponent(statusFilter)) : '';
        var res = yield axios__WEBPACK_IMPORTED_MODULE_34__/* ["default"] */ .A.get("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_36__/* .ENDPOINT_URL */ .m, "/technician-maintenance-Information?technician=").concat(encodeURIComponent((user === null || user === void 0 || (_user$data2 = user.data) === null || _user$data2 === void 0 ? void 0 : _user$data2.userName) || ''), "&isOffice=").concat(isOffice, "&page=").concat(page + 1, "&limit=").concat(limit, "&search=").concat(encodeURIComponent((searchTerm || '').trim())).concat(statusParam));
        var formatDate = res.data.itemI.map(item => _objectSpread(_objectSpread({}, item), {}, {
          id: item._id,
          serviceNumber: "M-00" + item.serviceNumber,
          dateField: dayjs__WEBPACK_IMPORTED_MODULE_42___default()(item.serviceDate).format('DD/MM/YYYY'),
          visit: dayjs__WEBPACK_IMPORTED_MODULE_42___default()(item.visitDate).format('DD/MM/YYYY')
        }));
  ...
  var columns = [{
    ...
    renderCell: params => user.data.role === 'User' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", null) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(DeleteTooltip, {
      ...
      disabled: MaintenanceInfoD.length === 0
  ...
  if (isMobile) {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component_Loader__WEBPACK_IMPORTED_MODULE_43__/* ["default"] */ .A, null)) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A, {
      sx: {
        width: '100%',
        py: 1
      }
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component_MobileCardList__WEBPACK_IMPORTED_MODULE_54__/* ["default"] */ .A, {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
  ...
  }, "Maintenance"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_NotificationVIewInfo__WEBPACK_IMPORTED_MODULE_52__/* ["default"] */ .A, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MessageAdminView__WEBPACK_IMPORTED_MODULE_51__/* ["default"] */ .A, {
    name: user.data.userName,
    role: user.data.role
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A, {
    color: "inherit",
    onClick: handleLogout
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component_NetworkLogoutIcon__WEBPACK_IMPORTED_MODULE_47__/* ["default"] */ .A, {
    style: {
      color: 'white'
    }
    ...
    color: '#9c27b0',
    bgLight: '#f3e5f5',
    icon: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material__WEBPACK_IMPORTED_MODULE_40__/* ["default"] */ .A, {
      sx: {
        fontSize: 15,
        color: '#9c27b0'
      }
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component_Loader__WEBPACK_IMPORTED_MODULE_43__/* ["default"] */ .A, null))) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A, {
    sx: {
      display: 'flex',
      justifyContent: 'space-between',
      alignItems: 'center',
    ...
    disabled: user.data.role !== 'CEO',
    className: "btnCustomer2"
  }, "Delete all")), !(0,_utils_isMobile__WEBPACK_IMPORTED_MODULE_53__/* .isNativeMobile */ .g1)() && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A, {
    sx: {
      display: 'flex',
      alignItems: 'center',
      gap: 1
    ...
    sx: {
      height: (0,_utils_isMobile__WEBPACK_IMPORTED_MODULE_53__/* .isNativeMobile */ .g1)() ? 'auto' : 'calc(100vh - 200px)',
      minHeight: 380,
      width: '100%'
    }
  }, (0,_utils_isMobile__WEBPACK_IMPORTED_MODULE_53__/* .isNativeMobile */ .g1)() ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component_MobileCardList__WEBPACK_IMPORTED_MODULE_54__/* ["default"] */ .A, {
    type: "maintenance_orders",
    data: maintenance
