...
/* harmony import */ var _component_MobileCardList__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(32297);
...
function MobileDetailSheet(_ref) {
  ...
  try {
    ...
    }, /*#__PURE__*/react.createElement("strong", null, "Repair Hist:"), " ", unit.repairHistory), unit.cleaningHistory && /*#__PURE__*/react.createElement(Typography/* default */.A, {
      variant: "caption",
      sx: {
        color: '#64748B',
        display: 'block'
      }
    }, /*#__PURE__*/react.createElement("strong", null, "Cleaning Notes:"), " ", unit.cleaningHistory))))), lineItems.length > 0 && /*#__PURE__*/react.createElement(Card/* default */.A, {
      sx: {
        borderRadius: 3.5,
        p: 2,
        mb: 2,
...
function MobileCardList(_ref) {
  ...
  var filtered = safeData.filter(item => {
    ...
    if (type === 'quotations' || type === 'estimates') {
      ...
      var numFmt = "est-".concat(String(item.estimateNumber || '').padStart(6, '0')).toLowerCase();
      return _cust.includes(q) || _num.includes(q) || numFmt.includes(q);
    }
    if (type === 'invoices') {
      ...
      var _num2 = MobileCardList_safeText(item.invoiceNumber).toLowerCase();
      var _numFmt = "inv-".concat(String(item.invoiceNumber || '').padStart(6, '0')).toLowerCase();
      return _cust2.includes(q) || _num2.includes(q) || _numFmt.includes(q);
    }
    if (type === 'customers') {
    ...
    if (type === 'maintenance') {
      ...
      var _num3 = MobileCardList_safeText(item.serviceNumber).toLowerCase();
      ...
      return defect.includes(q) || _cust3.includes(q) || _num3.includes(q) || _numFmt2.includes(q) || tech.includes(q);
    }
    if (type === 'maintenance_orders') {
      var _item$customerName5;
      var _num4 = MobileCardList_safeText(item.serviceNumber || item.orderNumber || item.maintenanceNumber).toLowerCase();
      ...
      return _num4.includes(q) || _numFmt3.includes(q) || _tech.includes(q) || _cust4.includes(q) || _defect.includes(q);
    }
    ...
    if (type === 'payments') {
      ...
      var _num5 = MobileCardList_safeText(item.paymentNumber).toLowerCase();
      return _cust5.includes(q) || _num5.includes(q);
    }
    if (type === 'expenses') {
    ...
    if (type === 'projects') {
      var _item$customerName7;
      var proj = MobileCardList_safeText(item.projectName || item.project).toLowerCase();
      var _cust6 = MobileCardList_safeText(((_item$customerName7 = item.customerName) === null || _item$customerName7 === void 0 ? void 0 : _item$customerName7.customerName) || item.customerName || item.customer).toLowerCase();
      return proj.includes(q) || _cust6.includes(q);
    }
    if (type === 'employees') {
  ...
  return /*#__PURE__*/react.createElement(Box/* default */.A, {
    ...
    // 1. Invoices
    if (type === 'invoices') {
      var _item$customerName8, _item$createdAt, _ref2, _ref3, _item$totalInvoice, _item$balanceDue;
      var customer = MobileCardList_safeText(((_item$customerName8 = item.customerName) === null || _item$customerName8 === void 0 ? void 0 : _item$customerName8.customerName) || item.customerName || item.customer, 'Global Gate Client');
    ...
    if (type === 'quotations' || type === 'estimates') {
      var _item$customerName9, _ref4, _item$totalEstimate;
      var _customer = MobileCardList_safeText(((_item$customerName9 = item.customerName) === null || _item$customerName9 === void 0 ? void 0 : _item$customerName9.customerName) || item.customerName || item.customer, 'Quotation Client');
    ...
    if (type === 'maintenance') {
      ...
      var _customer2 = MobileCardList_safeText(((_item$customerName0 = item.customerName) === null || _item$customerName0 === void 0 ? void 0 : _item$customerName0.customerName) || item.customerName || item.customer, 'Client');
    ...
    if (type === 'maintenance_orders') {
      ...
      var _customer3 = MobileCardList_safeText(((_item$customerName1 = item.customerName) === null || _item$customerName1 === void 0 ? void 0 : _item$customerName1.customerName) || item.customerName || item.customer, '');
    ...
    // 7. Payments
    if (type === 'payments') {
      var _item$customerName10, _ref9, _item$amount;
      var _customer4 = MobileCardList_safeText(((_item$customerName10 = item.customerName) === null || _item$customerName10 === void 0 ? void 0 : _item$customerName10.customerName) || item.customerName || item.customer, 'Client');
    ...
    // 9. Projects
    if (type === 'projects') {
      var _item$customerName11;
      var projName = MobileCardList_safeText(item.projectName || item.project, 'Project');
      var _customer5 = MobileCardList_safeText(((_item$customerName11 = item.customerName) === null || _item$customerName11 === void 0 ? void 0 : _item$customerName11.customerName) || item.customerName || item.customer, 'Client');
