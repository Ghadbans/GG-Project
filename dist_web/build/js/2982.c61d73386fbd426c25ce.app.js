...
function MaintenanceFormView() {
  ...
  var filterEmployee = employee.filter(row => (row.department === 'TECHNICIAN' || (row.department || '').toUpperCase() === 'TECHNICIAN') && row.Status !== 'Fired' && row.Status !== 'Resign' && row.Status !== 'Suspended');
  ...
  if (isMobile) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A, {
      ...
      value: ""
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("em", null, "Unassigned")), employee.filter(emp => emp.department === 'TECHNICIAN' || emp.role === 'TECHNICIAN' || emp.role === 'Technician').map(emp => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .A, {
