"use strict";
(this["webpackChunkgg_management"] = this["webpackChunkgg_management"] || []).push([[9971],{
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(36632);
...
/* harmony import */ var _mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(75737);
/* harmony import */ var _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(601);
/* harmony import */ var _mui_x_date_pickers_DatePicker__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(48484);
...
/* harmony import */ var react_toastify__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(99571);
...
/* harmony import */ var dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(90445);
/* harmony import */ var dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_42___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_42__);
...
dayjs__WEBPACK_IMPORTED_MODULE_41___default().extend((dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_42___default()));

// Global helper to parse dates robustly across formats
var parseDate = d => {
  if (!d) return dayjs__WEBPACK_IMPORTED_MODULE_41___default()(null);
  if (typeof d === 'string') {
    var formats = ['YYYY-MM-DD', 'DD/MM/YYYY', 'D/M/YYYY', 'DD-MM-YYYY', 'DD/MM/YY', 'D/M/YY', 'YYYY-MM-DDTHH:mm:ss.SSSZ'];
    var parsed = dayjs__WEBPACK_IMPORTED_MODULE_41___default()(d, formats, true);
    if (!parsed.isValid()) parsed = dayjs__WEBPACK_IMPORTED_MODULE_41___default()(d); // Fallback to native
    return parsed;
  }
  return dayjs__WEBPACK_IMPORTED_MODULE_41___default()(d);
};
var drawerWidth = 240;
...
function BlockSalesView() {
    ...
    var fetchData = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator(function* () {
        try {
          var _accRes$data;
          // Fetch Access
          var accRes = yield (0,_utils_apiCache__WEBPACK_IMPORTED_MODULE_6__/* .cachedGet */ .Fe)("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_39__/* .ENDPOINT_URL */ .m, "/grantAccess"));
          ...
          if (userAccess) {
            ...
            if (!isGG && !(blockAccess !== null && blockAccess !== void 0 && blockAccess.readM)) {
              react_toastify__WEBPACK_IMPORTED_MODULE_40__/* .toast */ .oR.error("You don't have permission to access Block Sales.");
              navigate('/AdminHome');
            }
          } else if (!isGG) {
            navigate('/AdminHome');
          ...
          // Fetch Configs
          var configRes = yield axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.get("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_39__/* .ENDPOINT_URL */ .m, "/block-config"));
          ...
          // Fetch Sales
          var salesRes = yield axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.get("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_39__/* .ENDPOINT_URL */ .m, "/block-sales"));
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
      date: dayjs__WEBPACK_IMPORTED_MODULE_41___default()().format('YYYY-MM-DD'),
      clientName: "",
      blockType: "",
      quantitySold: 0,
      pricePerUnit: 0,
    ...
    var _ref3 = _asyncToGenerator(function* () {
      ...
      try {
        ...
        if (editId) {
          ...
          yield axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.post("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_39__/* .ENDPOINT_URL */ .m, "/update-block-sales"), _objectSpread({
            id: targetId
          }, payload));
          react_toastify__WEBPACK_IMPORTED_MODULE_40__/* .toast */ .oR.success("Sales record updated!");
        } else {
          yield axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.post("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_39__/* .ENDPOINT_URL */ .m, "/create-block-sales"), payload);
          react_toastify__WEBPACK_IMPORTED_MODULE_40__/* .toast */ .oR.success("Sales record saved!");
        }
        ...
        react_toastify__WEBPACK_IMPORTED_MODULE_40__/* .toast */ .oR.error("Error saving record");
      } finally {
  ...
  var handleEdit = record => {
    ...
    react_toastify__WEBPACK_IMPORTED_MODULE_40__/* .toast */ .oR.info("Editing sales record.");
  };
      ...
      if (window.confirm("Are you sure you want to delete this sales record?")) {
        ...
        try {
          if (typeof serverId === 'string' && serverId.length > 10) {
            try {
              yield axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.post("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_39__/* .ENDPOINT_URL */ .m, "/delete-block-sales"), {
                id: serverId
              });
            } catch (err) {
          ...
          var salesRes = yield axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.get("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_39__/* .ENDPOINT_URL */ .m, "/block-sales"));
          if (salesRes.data.data) setRecentSales(salesRes.data.data);
          react_toastify__WEBPACK_IMPORTED_MODULE_40__/* .toast */ .oR.success("Sales record deleted!");
        } catch (error) {
          react_toastify__WEBPACK_IMPORTED_MODULE_40__/* .toast */ .oR.error("Error deleting record.");
        }
      }
    });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_Menu__WEBPACK_IMPORTED_MODULE_30__/* ["default"] */ .A, null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A, {
    variant: "h6",
    noWrap: true,
    component: "div",
    sx: {
  ...
  }, "Block Sales Tracking"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_NotificationVIewInfo__WEBPACK_IMPORTED_MODULE_31__/* ["default"] */ .A, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MessageAdminView__WEBPACK_IMPORTED_MODULE_32__/* ["default"] */ .A, {
  ...
  }, "New Sales Record"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Ay, {
    container: true,
    spacing: 2
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Ay, {
    item: true,
    xs: 12,
    sm: 4
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_27__/* .LocalizationProvider */ .$, {
    dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_28__/* .AdapterDayjs */ .R
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_DatePicker__WEBPACK_IMPORTED_MODULE_29__/* .DatePicker */ .l, {
    label: "Date",
    value: dayjs__WEBPACK_IMPORTED_MODULE_41___default()(salesData.date),
  ...
  }, ["Block 50", "Block 33", "Block 20", "Block 15", "Block 10", "Block 14", "Block 12"].map(b => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .A, {
    key: b,
    value: b
  }, b)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Ay, {
    item: true,
    xs: 12,
    sm: 4
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .A, {
  ...
  }, isSubmitting ? "Saving..." : "Save Sale"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Ay, {
    item: true,
    xs: 12,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .A, {
    ...
    variant: "h6"
  }, "Recent Sales"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A, {
    sx: {
      display: 'flex',
      gap: 2,
      flexWrap: 'wrap',
    ...
    variant: "caption",
    fontWeight: "bold"
  }, "Period:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_27__/* .LocalizationProvider */ .$, {
    dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_28__/* .AdapterDayjs */ .R
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_DatePicker__WEBPACK_IMPORTED_MODULE_29__/* .DatePicker */ .l, {
    label: "From",
    value: fromDate ? dayjs__WEBPACK_IMPORTED_MODULE_41___default()(fromDate) : null,
    ...
    label: "To",
    value: toDate ? dayjs__WEBPACK_IMPORTED_MODULE_41___default()(toDate) : null,
  ...
  }))))), !fromDate || !toDate ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_20__/* ["default"] */ .A, {
    severity: "warning",
    sx: {
      mt: 2,
      bgcolor: '#fffde7',
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("b", null, "No Filter Active:"), " Please select a date range to view sale records.") : filteredSales.length === 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_20__/* ["default"] */ .A, {
    severity: "info",
    sx: {
      mt: 2
    }
  }, "No sales records found for this period.") : null, fromDate && toDate && filteredSales.length > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
    size: "small"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .A, {
    sx: {
      backgroundColor: '#f5f5f5'
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_24__/* ["default"] */ .A, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    sx: {
      fontWeight: 'bold'
    }
  }, "Date"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    sx: {
      fontWeight: 'bold'
    }
  }, "Client"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    sx: {
      fontWeight: 'bold'
    }
  }, "Block"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    align: "right",
    sx: {
      fontWeight: 'bold'
    }
  }, "Qty"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    align: "right",
    sx: {
      fontWeight: 'bold'
    }
  }, "Amount"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    align: "center",
    sx: {
      fontWeight: 'bold'
    }
  }, "Actions"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_26__/* ["default"] */ .A, null, filteredSales.map(row => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_24__/* ["default"] */ .A, {
    key: row.id
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, null, dayjs__WEBPACK_IMPORTED_MODULE_41___default()(row.date).format('DD/MM/YYYY')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, null, row.clientName), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, null, row.blockType), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    align: "right"
  }, row.quantitySold), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    align: "right"
  }, (row.totalAmount || 0).toLocaleString(), " $"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_25__/* ["default"] */ .A, {
    align: "center"
