...
function PaymentInformationForm() {
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(() => {
    ...
    paymentDate = _useState14[0],
    setPaymentDate = _useState14[1];
  ...
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    ...
    paymentNumber = _useState18[0],
    setPaymentNumber = _useState18[1];
  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    _useState20 = _slicedToArray(_useState19, 2),
    rate = _useState20[0],
    setRate = _useState20[1];
  var _useState21 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('Payment'),
    _useState22 = _slicedToArray(_useState21, 2),
    transactionType = _useState22[0],
    setTransactionType = _useState22[1];
  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('Cleared'),
    _useState24 = _slicedToArray(_useState23, 2),
    status = _useState24[0],
    setStatus = _useState24[1];
  var _useState25 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('Payment'),
    _useState26 = _slicedToArray(_useState25, 2),
    paymentType = _useState26[0],
    setPaymentType = _useState26[1]; // Detailed type
  ...
  var _useState27 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    invoice = _useState28[0],
    setInvoice = _useState28[1];
  ...
  var _useState31 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
    ...
    oldInvoice = _useState32[0],
    setOldInvoice = _useState32[1];
  var _useState33 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
    _useState34 = _slicedToArray(_useState33, 2),
    customerId = _useState34[0],
    setCustomerId = _useState34[1];
  ...
  var _useState35 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    ...
    PaymentReceivedFC = _useState36[0],
    setPaymentReceivedFC = _useState36[1];
  var _useState37 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    _useState38 = _slicedToArray(_useState37, 2),
    PaymentReceivedUSD = _useState38[0],
    setPaymentReceivedUSD = _useState38[1];
  ...
  var _useState39 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    ...
    oldCredit = _useState40[0],
    setOldCredit = _useState40[1];
  var _useState41 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('Credit'),
    _useState42 = _slicedToArray(_useState41, 2),
    excessAction = _useState42[0],
    setExcessAction = _useState42[1];
  var _useState43 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    _useState44 = _slicedToArray(_useState43, 2),
    returnUSD = _useState44[0],
    setReturnUSD = _useState44[1];
  var _useState45 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
    _useState46 = _slicedToArray(_useState45, 2),
    returnFC = _useState46[0],
    setReturnFC = _useState46[1];
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    var fetchCustomer = /*#__PURE__*/function () {
    ...
    var _ref0 = _asyncToGenerator(function* () {
      if (reason === "Invoice") {
        var invoiceUpdate = invoice.length > 0 ? invoice.map(row => {
          ...
          var total = 0;
          var currentPaid = parseFloat(correspondingId.total || 0);
          var rowPaid = parseFloat(row.total || 0);
          ...
          var totalInv = parseFloat(correspondingId.totalInvoice || 0);
          var difference = Math.max(0, Math.round((totalInv - total) * 100) / 100);
          var status = correspondingId.status;
        ...
        if (updateRequest !== null) {
          try {
            ...
            (0,_utils_apiCache__WEBPACK_IMPORTED_MODULE_40__/* .invalidateCache */ .gm)('/invoice');
          } catch (error) {
  ...
  var handleSubmit = /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator(function* (e) {
      ...
      var data = {
        _id: (0,uuid__WEBPACK_IMPORTED_MODULE_55__/* ["default"] */ .A)(),
        customerName,
        amount,
        bankCharge,
        modes,
  ...
  if (isMobile) {
    ...
    }, "PAY-", String(paymentNumber || 1).padStart(6, '0')))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_53__/* ["default"] */ .A, {
      variant: "contained",
      size: "small",
    ...
    }, "Payment Recorded Successfully"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_53__/* ["default"] */ .A, {
      fullWidth: true,
      variant: "contained",
