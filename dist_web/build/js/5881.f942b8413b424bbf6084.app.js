  ...
  var fetchData = /*#__PURE__*/function () {
    var _ref0 = _asyncToGenerator(function* () {
      try {
        ...
        var res = yield axios__WEBPACK_IMPORTED_MODULE_34__/* ["default"] */ .A.get("".concat(_apiConfig__WEBPACK_IMPORTED_MODULE_40__/* .ENDPOINT_URL */ .m, "/get-purchase/").concat(id));
        ...
        setPurchaseNumber(Number(((_res$data = res.data) === null || _res$data === void 0 || (_res$data = _res$data.data) === null || _res$data === void 0 ? void 0 : _res$data.purchaseNumber) || ((_res$data2 = res.data) === null || _res$data2 === void 0 ? void 0 : _res$data2.purchaseNumber) || 0));
