...
function ProjectNameInfo(_ref3) {
  ...
  var newArray = search !== '' ? project.filter(row => (row.projectName ? row.projectName.toLowerCase().includes(search.toLowerCase()) : false) || (row.projectNumber !== undefined && row.projectNumber !== null ? row.projectNumber.toString().includes(search) : false) || (row.description ? row.description.toLowerCase().includes(search.toLowerCase()) : false) || (row.customerName && row.customerName.customerName ? row.customerName.customerName.toLowerCase().includes(search.toLowerCase()) : false)) : project;
  var newArray2 = search !== '' ? filteredRows.filter(row => (row.projectName ? row.projectName.toLowerCase().includes(search.toLowerCase()) : false) || (row.description ? row.description.toLowerCase().includes(search.toLowerCase()) : false) || (row.projectNumber !== undefined && row.projectNumber !== null ? row.projectNumber.toString().includes(search) : false) || (row.customerName && row.customerName.customerName ? row.customerName.customerName.toLowerCase().includes(search.toLowerCase()) : false)) : filteredRows;
