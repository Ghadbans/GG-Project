"use strict";
(this["webpackChunkgg_management"] = this["webpackChunkgg_management"] || []).push([[778,9250],{
...
function ProjectNameInfo(_ref3) {
  ...
  var matchProjectSearch = (row, term) => {
    var _row$customerName, _row$customerName2, _row$customerName3, _row$customerName4, _row$customerName5;
    if (!term) return true;
    var lower = term.toLowerCase().trim();
    var pNum = row.projectNumber !== undefined && row.projectNumber !== null ? String(row.projectNumber) : '';
    var pFormatted = pNum ? ('p-' + pNum.padStart(6, '0')).toLowerCase() : '';
    var cust = typeof row.customerName === 'string' ? row.customerName : ((_row$customerName = row.customerName) === null || _row$customerName === void 0 ? void 0 : _row$customerName.customerName) || ((_row$customerName2 = row.customerName) === null || _row$customerName2 === void 0 ? void 0 : _row$customerName2.companyName) || '';
    var custEmail = ((_row$customerName3 = row.customerName) === null || _row$customerName3 === void 0 ? void 0 : _row$customerName3.customerEmail) || '';
    var custPhone = ((_row$customerName4 = row.customerName) === null || _row$customerName4 === void 0 ? void 0 : _row$customerName4.customerPhone) || ((_row$customerName5 = row.customerName) === null || _row$customerName5 === void 0 ? void 0 : _row$customerName5.phone) || '';
    var desc = row.description || row.projectDescription || '';
    var pName = row.projectName || '';
    var status = row.status || '';
    var note = row.note || row.notes || '';
    var ref = row.ReferenceName || row.ReferenceName2 || '';
    return pName.toLowerCase().includes(lower) || desc.toLowerCase().includes(lower) || cust.toLowerCase().includes(lower) || custEmail.toLowerCase().includes(lower) || custPhone.toLowerCase().includes(lower) || status.toLowerCase().includes(lower) || note.toLowerCase().includes(lower) || ref.toLowerCase().includes(lower) || pNum.includes(lower) || pFormatted.includes(lower);
  };
  var newArray = search !== '' ? project.filter(row => matchProjectSearch(row, search)) : project;
  var newArray2 = search !== '' ? filteredRows.filter(row => matchProjectSearch(row, search)) : filteredRows;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A, {
      key: index,
      label: "".concat(((_row$customerName6 = row.customerName) === null || _row$customerName6 === void 0 ? void 0 : _row$customerName6.customerName) || 'Unknown', " | P-").concat(String(row.projectNumber).padStart(6, '0')),
    ...
    var _row$customerName7;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A, {
      key: index,
      label: "".concat(((_row$customerName7 = row.customerName) === null || _row$customerName7 === void 0 ? void 0 : _row$customerName7.customerName) || 'Unknown', " | P-").concat(String(row.projectNumber).padStart(6, '0')),
      component: react_router_dom__WEBPACK_IMPORTED_MODULE_9__/* .Link */ .N_,
      to: "/ProjectInfo/".concat(row._id),
      sx: {
        '&.Mui-selected': {
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(97834);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8239);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(47767);
/* harmony import */ var _ProjectNameInfo__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(39250);
/* harmony import */ var _component_SidebarDash__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4640);
/* harmony import */ var _mui_material_AppBar__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(89828);
/* harmony import */ var _mui_material_Drawer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(88248);
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(11848);
...
/* harmony import */ var _mui_icons_material_Menu__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(62274);
/* harmony import */ var _mui_icons_material_ChevronLeft__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(8451);
/* harmony import */ var _mui_icons_material_ArrowBack__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(92659);
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(13561);
/* harmony import */ var _features_auth_authSlice__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(32005);
/* harmony import */ var _component_NetworkLogoutIcon__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(40301);
...
var drawerWidth = 240;
var AppBar = (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Ay)(_mui_material_AppBar__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A, {
...
var Drawer = (0,_mui_material_styles__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Ay)(_mui_material_Drawer__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Ay, {
  shouldForwardProp: prop => prop !== 'open'
})(_ref2 => {
  var theme = _ref2.theme,
    open = _ref2.open;
...
function ProjectViewLayout() {
  ...
  var user = (0,react_redux__WEBPACK_IMPORTED_MODULE_19__/* .useSelector */ .d4)(_features_auth_authSlice__WEBPACK_IMPORTED_MODULE_20__/* .selectCurrentUser */ .xu);
  ...
  var handleLogout = () => {
    ...
    dispatch((0,_features_auth_authSlice__WEBPACK_IMPORTED_MODULE_20__/* .logOut */ .je)());
    navigate('/');
  };
  var handleShow1 = val => {
    setShow1(val);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A, {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_Menu__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .A, null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A, {
    component: "h1",
    variant: "h6",
    color: "inherit",
    noWrap: true,
  ...
  }, "Project Information"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A, {
    onClick: () => navigate('/ProjectViewAdmin')
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_ArrowBack__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .A, {
    style: {
      color: 'white'
    }
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_NotificationVIewInfo__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .A, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_MessageAdminView__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .A, {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component_NetworkLogoutIcon__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .A, {
    style: {
      color: 'white'
    }
    ...
    onClick: toggleDrawer
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_ChevronLeft__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .A, null))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .A, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .A, {
    sx: {
      height: '700px'
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_component_SidebarDash__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A, null))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A, {
    component: "main",
    sx: {
    ...
    container: true,
    spacing: 2
  }, show1 === 1 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Ay, {
    item: true,
    xs: 3
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ProjectNameInfo__WEBPACK_IMPORTED_MODULE_7__["default"], {
    onId: id
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Ay, {
    item: true,
    xs: show1 === 1 ? 9 : 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__/* .Outlet */ .sv, {
    context: {
      handleShow1
    }
  }))))));
