...
function MobileCardList(_ref) {
  ...
  return /*#__PURE__*/react.createElement(Box/* default */.A, {
    ...
    // 8. Daily Expenses
    if (type === 'expenses') {
      var _item$expenseCategory2, _ref12, _item$amount2;
      ...
      var _amount = Number((_ref12 = (_item$amount2 = item.amount) !== null && _item$amount2 !== void 0 ? _item$amount2 : item.total) !== null && _ref12 !== void 0 ? _ref12 : 0);
      return /*#__PURE__*/react.createElement(Card/* default */.A, {
        key: id,
        onClick: () => setSelectedRecord(item),
        sx: {
