...
function SellShopInvoiceView() {
  ...
  var infoFromState = (selectedRows || []).map(id => {
    var found = (invoice || []).find(inv => inv._id === id || inv.id === id);
    return found !== null && found !== void 0 && found.factureNumber ? "S-00".concat(found.factureNumber) : '';
  }).filter(Boolean);
  var info = infoFromState.length > 0 ? infoFromState.join(', ') : InvoiceDeleted.length > 0 ? InvoiceDeleted.join(', ') : selectedRows.length > 0 ? "".concat(selectedRows.length, " invoice(s)") : '';
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(Box/* default */.A, {
    ...
    variant: "h6",
    component: "h2"
  }, "Why do you want to delete: ", info || (selectedRows.length > 1 ? "".concat(selectedRows.length, " selected invoices") : 'this invoice'), "?"), /*#__PURE__*/react.createElement("form", {
