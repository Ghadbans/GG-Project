...
function EstimateInformation(_ref3) {
  ...
  var matchEstimateSearch = (row, query) => {
    ...
    var qFmt = ('q-' + String(row.estimateNumber || '').padStart(6, '0')).toLowerCase();
    ...
    return estName.includes(s) || estSub.includes(s) || estDef.includes(s) || estNum.includes(s) || qFmt.includes(s) || custName.includes(s) || matchesItem;
  };
  var formatQuotationLabel = row => {
    var _row$customerName3;
    var cust = ((_row$customerName3 = row.customerName) === null || _row$customerName3 === void 0 ? void 0 : _row$customerName3.customerName) || '';
    var qNum = row.estimateNumber !== undefined && row.estimateNumber !== null ? 'Q-' + String(row.estimateNumber).padStart(6, '0') : (row.estimateName || '').replace(/^(EST|QUO|QT|Q)\s*-?/i, 'Q-');
    return "".concat(cust, " | ").concat(qNum);
  };
...
function EstimateViewAdminAll() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    var _row$customerName, _ref14, _data, _row$items, _data2, _data3, _row$items2, _data4;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      key: row._id
    ...
    }, ((_row$customerName = row.customerName) === null || _row$customerName === void 0 || (_row$customerName = _row$customerName.customerName) === null || _row$customerName === void 0 ? void 0 : _row$customerName.toUpperCase()) || '', " | ", row.estimateNumber !== undefined && row.estimateNumber !== null ? 'Q-' + String(row.estimateNumber).padStart(6, '0') : (_ref14 = row.estimateName || row.invoiceName) === null || _ref14 === void 0 ? void 0 : _ref14.replace(/^(EST|QUO|QT|Q)\s*-?/i, 'Q-'), " ")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A, {
