...
function AdminHome() {
    ...
    const fetchAll = async () => {
      if (navigator.onLine && !user.isHibernating) {
        try {
          ...
          const resExpenses = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/dailyExpense-Information?page=1&limit=1000&filterField=expenseDate&filterValue=${currentYear}`);
          setExpenses(resExpenses.data.itemI);
          const resItemPurchase = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/itemPurchase')
          ...
          const resPosInvoice = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/pos-Information?page=1&limit=500&filterField=invoiceDate&filterValue=${currentYear}`)
          ...
          const resItem = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/item-shop?page=1&limit=500')
          ...
          const resAttendance = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/employeeattendance')
  ...
  const fetchValue = async () => {
    try {
      const resItemOutItemReturn = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/item-usage')
