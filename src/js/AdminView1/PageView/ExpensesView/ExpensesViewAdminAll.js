...
useEffect(()=> {
  axios.get('https://globalgate-backend-production.up.railway.app/endpoint/comment')
           .then(res => {
                   // Handle the response data here
...
const CommentInfo = 
  ...
  const handleSubmitEdit = (e) => {
   ...
   axios.post('https://globalgate-backend-production.up.railway.app/endpoint/create-comment/',data)
    .then((res) => {
      if (res) {
        setReason("");
        handleOpen();
