...
function ExpensesViewAdminAll() {
  ...
  const handleSubmitEdit = (e) => {
    ...
    axios.post(`${ENDPOINT_URL}/create-comment/`, data)
      .then((res) => {
        if (res) {
          setReason("");
          handleOpen();
                              ...
                              <div style={{ display: 'flex', lineHeight: '2px', fontSize: '1rem', width: '100%' }} >
                                ...
                                <NavLink to={`/ExpensesViewAdminAll/${row._id}`} className='LinkName' style={{ width: '75%' }}>
                                  <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center' }}>
                                    ...
                                    <div>
                                      <Typography>INV-{String(row.referenceNumber).padStart(6, '0')}</Typography>
                        ...
                        <Grid container style={{ alignItems: 'center', padding: '10px' }} spacing={3}>
                          <Grid item xs={10}>
                            <Autocomplete
                              ...
                              renderOption={(props, option) => (<Box {...props}>{option.customerName.customerName.toUpperCase()}/INV-{String(option.referenceNumber).padStart(6, '0')}
                              </Box>)}
                                    ...
                                    <table className='tableItemInfo'>
                                      <tbody>
                                        <tr>
                                          ...
                                          <td><Typography >INV-{String(row.referenceNumber).padStart(6, '0')}</Typography></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                    <table className='tableItemInfo'>
