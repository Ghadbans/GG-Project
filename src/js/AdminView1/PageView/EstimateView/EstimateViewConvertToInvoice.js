...
useEffect(()=> {
  const fetchCustomer = async ()=>{
   if (customerName) {
     try {
      const res = await axios.get(`https://gg-project-productionn.up.railway.app/endpoint/get-customer/${customerName._id}`)
...
{/** Item InFO End */}
     ...
     const [saving,setSaving] = useState('')
            const handleSubmit = async (e) =>{
              ...
              try {
                const res = await  axios.post('https://gg-project-productionn.up.railway.app/endpoint/create-invoice', {
                  customerName,
                  invoiceNumber,
                  invoiceDate,
                  invoiceName,
