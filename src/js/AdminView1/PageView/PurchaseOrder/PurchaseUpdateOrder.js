...
function PurchaseUpdateOrder() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-purchaseOrder/${id}`, data);
      if (res) {
        // Open Loading View
        handleCreateComment()
        handleOpen();
  ...
  useEffect(() => {
    const fetchNumber = async () => {
      if (navigator.onLine) {
        try {
          const resItemOut = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/get-last-saved-purchaseOrder')
  ...
  const handleSubmitClone = async (e) => {
    ...
    try {
      const res = await axios.post('https://globalgate-backend-production.up.railway.app/endpoint/create-purchaseOrder', data);
      if (res) {
        // Open Loading View
