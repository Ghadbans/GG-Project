...
function ItemOutViewForm() {
  ...
  useEffect(() => {
    const handleFetch = async () => {
      try {
        const resItemOut = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/get-last-saved-itemOut')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('https://globalgate-backend-production.up.railway.app/endpoint/create-itemOut', data);
      if (res) {
        // Open Loading View
