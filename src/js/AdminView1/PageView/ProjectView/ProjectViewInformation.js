    ...
    const fetchProject = async () => {
      if (navigator.onLine) {
        try {
          ...
          const res = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-projects/${id}`)
  ...
  useEffect(() => {
    if (navigator.onLine) {
      try {
        ...
        const resP = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-projects/${id}`)
    ...
    if (navigator.onLine) {
      try {
        ...
        const [resInvoice, resItemOut, resIReturn, resIPurchase, resCategory, resExpenses, resNotification, resPlaning] = await Promise.all([
          axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/invoice/project/${id}`),
          axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/itemOut/project/${id}`),
          axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/itemReturn/project/${id}`),
          axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/itemPurchase/project/${id}`),
          axios.get('https://globalgate-backend-production.up.railway.app/endpoint/expensesCategory'),
          axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/expense/project/${id}`),
          axios.get('https://globalgate-backend-production.up.railway.app/endpoint/notification'),
...
{/** const resItemOut = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/itemOut')
         ...
         const resIReturn = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/itemReturn')
...
const updateForItemBuy = async (e) => {
  ...
  const saveAttendance = purchaseInfo.map((row) => {
    return axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-purchase/${row._id}`, row)
  })
  try {
