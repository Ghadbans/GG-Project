      ...
      fetchData()
        ...
        useEffect(()=>{
          const handleFetch = async () => {
           if (navigator.onLine) {
             try {
               const resCustomer = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/customer')
...
const handleUpdatePurchase = async () => {
    ...
    if (purchase !== null) {
       if (navigator.onLine) {
         try {
           await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-purchase/${purchase}`,data)
...
const handleSubmit =async (e)=>{
   ...
   if (navigator.onLine) {
     try{
       const res = await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-projects/${id}`,data);
       if (res) {
         // Open Loading View
