...
const PrintPayRoll = React.forwardRef(({id},ref) => {
  ...
  return (
    <div>
           ...
           <tbody>
          <tr>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Employee Name</td>
            <td style={{width:'20%',border:'1px solid #DDD'}} colSpan={2}>{row.employeeName.name?row.employeeName.name:''}</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Total Days</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}> {row.daysOpen}  
             </td>
          </tr>
          <tr>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Employee Details</td>
            <td style={{width:'20%',border:'1px solid #DDD'}} colSpan={2}>{related.employeePhone !==undefined?related.employeePhone:''}</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>LOPs</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>   
            {row.Lops} 
             </td>
          </tr>
          <tr>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Employee Id</td>
            <td style={{width:'20%',border:'1px solid #DDD'}} colSpan={2}>{related.employeeId}</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Paid Days</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>   
            {row.daysW} 
              </td>
          </tr>
          <tr>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Grade</td>
            <td style={{width:'20%',border:'1px solid #DDD'}} colSpan={2}>{related.employeeRole}</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Bank Name</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>{related.bankName}</td>
          </tr>
          <tr>
            <td style={{width:'20%',border:'1px solid #DDD'}}>Date</td>
            <td style={{width:'20%',border:'1px solid #DDD'}} colSpan={2}>{dayjs(row.payDate).format('DD-MMMM-YYYY')}</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>A/C No.</td>
            <td style={{width:'20%',border:'1px solid #DDD'}}>{related.bankAccountNumber}</td>
          </tr>
          <tr>
            <td style={{width:'40%',border:'1px solid #DDD'}} colSpan={2}>Department</td>
            <td style={{width:'40%',border:'1px solid #DDD'}} colSpan={3}>{related.department}</td>
          </tr>
        </tbody>
           <thead>
             <tr>
           ...
           <tbody>
             <tr>
               ...
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>{row.earningSalary}</td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>In advanced allowances </td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>{row.advancedSalary}</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}> {row.bounceAllowancesEarning}</td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>Loan recovery</td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>{row.loan}</td>
             </tr>
             <tr>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>Other</td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>{row.other}</td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}> {row.otherEarning}</td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>Item lost recovery / Deduction</td>
               <td style={{width:'20%',border:'1px solid #DDD', color:'black'}}>{row.itemLost}</td>
             </tr>
             </tbody>
         </table>
