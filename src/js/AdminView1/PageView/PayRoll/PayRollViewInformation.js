                              ...
                              <div style={{ height: 'calc(100vh - 170px)', overflow: 'hidden', overflowY: 'scroll', width: '100%' }}>
                                ...
                                >
                                  {payRoll?.map((row, index) => {
                                    const periodStr = row.weekFrom && row.weekTo 
                                      ? ` | ${dayjs(row.weekFrom).format('DD/MM')} - ${dayjs(row.weekTo).format('DD/MM')}`
                                      : '';
                                    return (
                                      <Tab
                                        key={index}
                                    ...
                                    <div ref={componentRef} className="print-container">
                                      ...
                                      <table className="secondTable" style={{ width: '100%', marginBottom: '0px', border: '1px solid #DDD' }}>
                                        <thead>
                                          ...
                                          <tr>
                                            <th style={{ padding: '5px', border: '1px solid #DDD', color: 'black', backgroundColor: '#e8f7fe' }} colSpan={5}>
                                      ...
                                      <table className="secondTable" style={{ width: '100%', marginBottom: '5px', border: '1px solid #DDD', color: 'black' }}>
                                        <tbody>
                                          ...
                                          {row.weekFrom && row.weekTo && (
                                            <tr>
                                              <td style={{ padding: '5px', border: '1px solid #DDD', color: '#1a237e', textAlign: 'center', fontWeight: 'bold', backgroundColor: '#f1f8e9' }} colSpan={6}>
                                                PERIOD: {dayjs(row.weekFrom).format('DD/MM/YYYY')} TO {dayjs(row.weekTo).format('DD/MM/YYYY')}
                                              </td>
                                            </tr>
                                          )}
                                          <tr>
