...
function RecurringInvoiceFormUpdate() {
  const {id} = useParams();
  const navigate = useNavigate();
  useEffect (() => {
    axios.get(`https://gg-project-productionn.up.railway.app/endpoint/get-recurringinvoice/${id}`)
    .then(res => {
    ...
    const handleSubmitEdit = (e) => {
     ...
     axios.put(`https://gg-project-productionn.up.railway.app/endpoint/update-recurringinvoice/${id}`,data)
      .then((res) => {
...
export default RecurringInvoiceFormUpdate
