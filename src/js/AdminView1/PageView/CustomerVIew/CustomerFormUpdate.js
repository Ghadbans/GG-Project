      ...
      <Box sx={{ width: '100%', minHeight: '100vh', backgroundColor: '#F8FAFC', pb: 12 }}>
          ...
          <Box sx={{ ...style, width: '90%', maxWidth: 400, borderRadius: 4, textAlign: 'center', p: 3 }}>
            {loading ? <Loader /> : (
              <div>
                ...
                <Typography variant="h6" sx={{ fontWeight: 800 }}>Updated Successfully</Typography>
        ...
        <Modal open={ErrorOpenModal} onClose={handleCloseError}>
          <Box sx={{ ...style, width: '90%', maxWidth: 400, borderRadius: 4, textAlign: 'center', p: 3 }}>
            ...
            <Typography variant="body2" sx={{ color: '#64748B', mt: 1 }}>Please check required fields and try again.</Typography>
