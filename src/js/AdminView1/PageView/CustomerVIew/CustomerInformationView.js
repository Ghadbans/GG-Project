...
function CustomerInformationView() {
  ...
  const apiUrl = 'https://globalgate-backend-production.up.railway.app/endpoint/customer';
  useEffect(() => {
      ...
      if (navigator.onLine) {
        try {
          ...
          const [resCustomer, resEstimate, resInvoice, resPurchase, resMaintenance, resPayment, resPos] = await Promise.all([
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-customer/${id}`),
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/estimation/customer/${id}`),
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/invoice/customer/${id}`),
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/purchase/customer/${id}`),
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/maintenance/customer/${id}`),
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/payment/customer/${id}`),
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/pos/customer/${id}`)
          ]);
  ...
  const handleUpdateCredit = async (e) => {
    ...
    if (navigator.onLine) {
      try {
        const res = await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-customer/${id}`, data)
        if (res) {
          setIsCredit('true')
          handleOpen();
        }
