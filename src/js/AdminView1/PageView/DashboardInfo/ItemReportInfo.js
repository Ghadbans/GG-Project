                ...
                <TableBody>
                  {
                    newArray.map((row) => (
                      <TableRow key={row._id}>
                        <TableCell>{row.itemUpc ? `${row.itemUpc.newCode}-${row.itemUpc.itemNumber}` : 'N/A'}</TableCell>
                        <TableCell align="left">{row.itemName || 'N/A'}</TableCell>
                        <TableCell align="left">{row.itemBrand || ''}</TableCell>
                        <TableCell align="left">{row.itemDescription || ''}</TableCell>
                        <TableCell align="right">{Number(row.itemQuantity || 0).toLocaleString()}</TableCell>
                      </TableRow>
                    ))
                  }
                </TableBody>
