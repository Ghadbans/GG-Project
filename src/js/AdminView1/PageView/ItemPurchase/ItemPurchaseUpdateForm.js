...
function ItemPurchaseUpdateForm() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const res = await axios.get(`https://gg-project-productionn.up.railway.app/endpoint/get-itemPurchase/${id}`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(`https://gg-project-productionn.up.railway.app/endpoint/update-itemPurchase/${id}`, data)
      if (res) {
        // Open Loading View
        //Update Item Qty
        //handleUpdateQty();
