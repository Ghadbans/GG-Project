...
function ItemCommentForm({onCreateOption,onId}) {
  ...
  useEffect(()=> {
    ...
    useEffect (() => {
        axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-item/${onId}`)
        .then(res => {
    ...
    const Comments = [ ...Comments1, CommentInfo];
     ...
     const fetchingData = async () => {
        try {
            const res = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-item/${onId}`)
     ...
     const handleSubmitEdit = (e) => {
      ...
      axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-item/${onId}`,data)
       .then((res) => {
         if (res) {
           setReason("");
           handleOpen();
