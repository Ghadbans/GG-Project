...
function UserAccount() {
  ...
  useEffect(() => {
    const fetchData2 = async () => {
      ...
      if (DeleteId !== null) {
        try {
          const res = await axios.get(`https://gg-project-productionn.up.railway.app/endpoint/get-employeeuser/${DeleteId}`)
  ...
  const handleDelete = async (e) => {
    e.preventDefault()
    try {
      const res = await axios.delete(`https://gg-project-productionn.up.railway.app/endpoint/delete-employeeuser/${DeleteId}`);
      if (res) {
  ...
  useEffect(() => {
    const fetchRelated = async () => {
      if (updateId !== null) {
        try {
          const res = await axios.get(`https://gg-project-productionn.up.railway.app/endpoint/get-employeeuser/${updateId}`)
