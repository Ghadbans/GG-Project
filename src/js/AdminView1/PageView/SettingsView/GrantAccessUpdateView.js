...
function GrantAccessUpdateView() {
  ...
  useEffect(()=> {
    const fetchData = async () => {
      try {
        const res = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-grantAccess/${id}`)
...
const handleCreateComment = async () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      const res = await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-grantAccess/${id}`,data)
      if (res) {
         // Open Loading View
         handleCreateComment()
        handleOpen();
