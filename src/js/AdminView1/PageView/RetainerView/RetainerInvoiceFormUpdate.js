...
function RetainerInvoiceFormUpdate() {
  ...
  useEffect (() => {
    axios.get(`https://gg-project-productionn.up.railway.app/endpoint/get-retainerinvoice/${id}`)
    .then(res => {
    ...
    const handleSubmitEdit = (e) => {
     ...
     axios.put(`https://gg-project-productionn.up.railway.app/endpoint/update-retainerinvoice/${id}`,data)
      .then((res) => {
