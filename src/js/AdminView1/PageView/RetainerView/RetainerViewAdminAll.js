...
import RetainerInformation from './RetainerInformation';
...
function RetainerViewAdminAll() {
  ...
  const apiUrl = 'https://gg-project-productionn.up.railway.app/endpoint/retainerinvoice';
  useEffect(()=> {
  axios.get(apiUrl)
  .then(res => {
  ...
  return (
    ...
    <div className='header'>
     <div className='headername'>
       <Typography variant='h5'>Retainer Invoice</Typography>
     </div>
     <div className='box1'>
...
<div className='itemInfoContainer4'>
 ...
 <hr/>
 <div style={{height:'120px', overflow:'hidden',overflowY:'scroll'}}>
  <p> Estimation details...
  </p>
  <p> Estimation details...
  </p>
  <p> Estimation details...
        ...
        <table className="firstTable2">
            <tbody>
              ...
              <tr>
                ...
                <td style={{ borderBottom:'1px solid black'}}><span >0.00</span></td>
              </tr>
              </tbody>
              <tbody>
              <tr>
              ...
              <tr>
                ...
                <td style={{ borderBottom:'1px solid black', color:'#66a3ca'}}><span data-prefix >$</span><span>{row.balanceDue}</span></td>
              </tr>
              </tbody>
              <tbody>
              <tr>
...
export default RetainerViewAdminAll
