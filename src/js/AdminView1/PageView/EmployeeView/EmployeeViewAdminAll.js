...
function EmployeeViewAdminAll() {
  ...
  const apiUrl = 'https://globalgate-backend-production.up.railway.app/endpoint/employee';
      ...
      if (navigator.onLine) {
        try {
          const [res, resPayRoll, resPlaning, resDE, resItemOut] = await Promise.all([
            axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-employee/${id}`),
            axios.get('https://globalgate-backend-production.up.railway.app/endpoint/payRoll'),
            axios.get('https://globalgate-backend-production.up.railway.app/endpoint/planing'),
            axios.get('https://globalgate-backend-production.up.railway.app/endpoint/expense'),
            axios.get('https://globalgate-backend-production.up.railway.app/endpoint/itemOut')
          ]);
  ...
  useEffect(() => {
    const fetchImages = async () => {
      if (employeeName !== null) {
        try {
          const resp = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-image/${employeeName}`);
  ...
  const handleImageSubmit = async (e) => {
    ...
    try {
      await axios.post('https://globalgate-backend-production.up.railway.app/endpoint/upload-image', formData, {
        headers: {
  ...
  const handleDeleteImage = async (e) => {
    ...
    if (images !== null) {
      try {
        const res = await axios.delete(`https://globalgate-backend-production.up.railway.app/endpoint/delete-image/${images._id}`)
        if (res) {
          handleOpenDelete()
        }
      } catch (error) {
