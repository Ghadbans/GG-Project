                                      ...
                                      {(() => {
                                        ...
                                        return (
                                          <Card sx={{ p: 2 }}>
                                            ...
                                            {/* Notes */}
                                            {report.notes && (
                                              <Paper sx={{ p: 2, backgroundColor: '#fffbeb', border: '1px solid #fef3c7' }}>
                                                <Typography variant="subtitle2" sx={{ fontWeight: 'bold', color: '#92400e', mb: 0.5 }}>
