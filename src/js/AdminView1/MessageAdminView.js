  ...
  const handleOffline = () => {
    ...
    useEffect(()=> {
        const fetchComment = async () => {
            try {
              const res = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/message')
         ...
         useEffect(()=>{
          ...
          if (idEdit !== null) {
                   try {
                     const res = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-message/${idEdit}`);
         ...
         const handleDeleteUpdate = async (e) => {
          e.preventDefault()
          try {
            const res = await axios.delete(`https://globalgate-backend-production.up.railway.app/endpoint/delete-message/${DeleteId}`);
            if (res) {
              setUpdateD('Delete')
              handleOpen();
                   }} 
         ...
         const handleSubmit =async (e)=>{
          ...
          const data = {
           ...
           try{
             const res = await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-message/${idEdit}`,data);
             if (res) {
              setUpdateD('true')
              handleOpen();
             }
         ...
         const handleSubmitEdit = async (e) => {
            ...
            try {
              const res = await axios.post('https://globalgate-backend-production.up.railway.app/endpoint/create-message/',data)
              if (res) {
                setUpdateD('saved')
                setMessage("");
                handleOpen();
