...
function RateViewAdmin() {
  ...
  useEffect(() => {
    const fetchRateId = async () => {
      if (updateId !== null) {
        try {
          const res = await axios.get(`${ENDPOINT_URL}/get-rate/${updateId}`)
  ...
  useEffect(() => {
    const fetchRateId = async () => {
      if (updateId1 !== null) {
        try {
          const res = await axios.get(`${ENDPOINT_URL}/get-rateReturn/${updateId1}`)
  ...
  useEffect(() => {
    const fetchPayId = async () => {
      if (updateIdRate !== null) {
        try {
          const res = await axios.get(`${ENDPOINT_URL}/get-paymentRate/${updateIdRate}`)
  ...
  const handleSubmitUpdateStatus = async (e) => {
    ...
    try {
      const res = await axios.put(`${ENDPOINT_URL}/update-rate/${updateId}`, data)
      if (res) {
        handleOpenLoading();
      }
    } catch (error) {
  ...
  const handleSubmitUpdateStatusReturn = async (e) => {
    ...
    try {
      const res = await axios.put(`${ENDPOINT_URL}/update-rateReturn/${updateId1}`, data)
      if (res) {
        handleOpenLoading();
      }
    } catch (error) {
  ...
  const handleSubmitUpdateStatusRate = async (e) => {
    ...
    try {
      const res = await axios.put(`${ENDPOINT_URL}/update-paymentRate/${updateIdRate}`, data)
      if (res) {
        handleOpenLoading();
      }
    } catch (error) {
