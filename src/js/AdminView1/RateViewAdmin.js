      ...
      useEffect(()=> {
        const fetchData = async () => {
          try {
            ...
            const resReturn = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/rateReturn')
            setRateReturned(resReturn.data.data);
            localStorage.setItem('Rate', JSON.stringify(res.data.data))
            const resRatePayment = await axios.get('https://globalgate-backend-production.up.railway.app/endpoint/paymentRate')
...
useEffect(()=>{
  const fetchRateId = async ()=> {
    if (updateId !== null) {
    try {
      const res = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-rate/${updateId}`)
...
useEffect(()=>{
  const fetchRateId = async ()=> {
    if (updateId1 !== null) {
    try {
      const res = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-rateReturn/${updateId1}`)
...
useEffect (() => {
  const fetchPayId = async ()=> {
    ...
    try {
      const res = await axios.get(`https://globalgate-backend-production.up.railway.app/endpoint/get-paymentRate/${updateIdRate}`)
...
const handleSubmitUpdateStatus = async (e) => {
  ...
  try {
    const res = await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-rate/${updateId}`,data)
    if (res) {
      handleOpenLoading();
    }
  } catch (error) {
...
const handleSubmitUpdateStatusReturn = async (e) => {
  ...
  try {
    const res = await axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-rateReturn/${updateId1}`,data)
    if (res) {
      handleOpenLoading();
    }
  } catch (error) {
...
const handleSubmitUpdateStatusRate = async (e) => {
  ...
  try {
    const res = await  axios.put(`https://globalgate-backend-production.up.railway.app/endpoint/update-paymentRate/${updateIdRate}`,data)
    if (res) {
      handleOpenLoading();
    }
  } catch (error) {
