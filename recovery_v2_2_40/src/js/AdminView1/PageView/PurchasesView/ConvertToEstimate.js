...
function ConvertToEstimate() {
    ...
    const handleLogout = () => {
      ...
      const apiUrl = 'http://192.168.0.200:8080/endpoint/create-estimation';
    ...
    useEffect(()=>{
      axios.get('http://192.168.0.200:8080/endpoint/item')
      .then(res => {
              // Handle the response data here
...
const handleChange = (e,i) => {
    ...
    useEffect(()=>{
        axios.get(`http://192.168.0.200:8080/endpoint/get-purchase/${id}`)
        .then(res => {
            // Handle the response data here
 ...
 useEffect(()=> {
    axios.get('http://192.168.0.200:8080/endpoint/customer')
    .then(res => {
            // Handle the response data here
...
const handleCreateItem = (newItem)=> {
  ...
  const handleSubmitStatusUpdate = (ReferenceInfo) => {
      ...
      axios.put(`http://192.168.0.200:8080/endpoint/update-purchase/${id}`,data)
   }
