...
import { MenuItem, Grid, IconButton, Paper, TextField, FormControl, InputLabel, Select, Typography, styled, Box, Autocomplete, Modal, Backdrop, TableContainer, OutlinedInput, InputAdornment, Divider, Drawer as SideDrawer, Card, CardContent, CardMedia, Button, Pagination } from '@mui/material'
...
function ItemOutViewForm() {
  ...
  useEffect(() => {
    const handleFetch = async () => {
      try {
        const resItemOut = await axios.get('http://192.168.0.200:8080/endpoint/get-last-saved-itemOut')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://192.168.0.200:8080/endpoint/create-itemOut', data);
      if (res) {
        // Open Loading View
