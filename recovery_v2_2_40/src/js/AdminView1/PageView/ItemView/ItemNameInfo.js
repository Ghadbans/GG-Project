...
function ItemNameInfo({onId}) {
    ...
    row.typeItem.toLowerCase().includes(search.toLowerCase())||
    row.itemDescription && row.itemDescription.toLowerCase().includes(search.toLowerCase())||
    row.itemName.toLowerCase().includes(search.toLowerCase()) ||
    row.itemBrand.toLowerCase().includes(search.toLowerCase())  ||
    row.itemManufacturer.toLowerCase().includes(search.toLowerCase())  ||
    row.itemStore.toLowerCase().includes(search.toLowerCase())  
     ):item
  return (
    <div>
   { show ===1  ?     
