...
function PurchaseUpdateOrder() {
  ...
  const handleAddToPurchaseOrderUpdate = (shopItem) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(`http://192.168.0.200:8080/endpoint/update-purchaseOrder/${id}`, data);
      if (res) {
        // Open Loading View
        handleCreateComment()
        handleOpen();
                    ...
                    <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                      ...
                      <CardContent sx={{ flexGrow: 1, padding: '10px' }}>
                        ...
                        <Button
                          ...
                          size="small"
                          fullWidth
                          onClick={() => handleAddToPurchaseOrderUpdate(item)}
                          sx={{ marginTop: '5px' }}
                        >
                          Add
                        </Button>
