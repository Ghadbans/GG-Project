      ...
      useEffect(()=> {
        const fetchData = async () => {
          try {
            ...
            const resReturn = await axios.get('http://192.168.0.200:8080/endpoint/rateReturn')
            setRateReturned(resReturn.data.data);
            localStorage.setItem('Rate', JSON.stringify(res.data.data))
            const resRatePayment = await axios.get('http://192.168.0.200:8080/endpoint/paymentRate')
...
useEffect(()=>{
  const fetchRateId = async ()=> {
    if (updateId !== null) {
    try {
      const res = await axios.get(`http://192.168.0.200:8080/endpoint/get-rate/${updateId}`)
...
useEffect(()=>{
  const fetchRateId = async ()=> {
    if (updateId1 !== null) {
    try {
      const res = await axios.get(`http://192.168.0.200:8080/endpoint/get-rateReturn/${updateId1}`)
...
useEffect (() => {
  const fetchPayId = async ()=> {
    ...
    try {
      const res = await axios.get(`http://192.168.0.200:8080/endpoint/get-paymentRate/${updateIdRate}`)
...
const handleSubmitUpdateStatus = async (e) => {
  ...
  try {
    const res = await axios.put(`http://192.168.0.200:8080/endpoint/update-rate/${updateId}`,data)
    if (res) {
      handleOpenLoading();
    }
  } catch (error) {
...
const handleSubmitUpdateStatusReturn = async (e) => {
  ...
  try {
    const res = await axios.put(`http://192.168.0.200:8080/endpoint/update-rateReturn/${updateId1}`,data)
    if (res) {
      handleOpenLoading();
    }
  } catch (error) {
...
const handleSubmitUpdateStatusRate = async (e) => {
  ...
  try {
    const res = await  axios.put(`http://192.168.0.200:8080/endpoint/update-paymentRate/${updateIdRate}`,data)
    if (res) {
      handleOpenLoading();
    }
  } catch (error) {
