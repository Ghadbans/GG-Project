  ...
  const handleOffline = () => {
    ...
    useEffect(()=> {
        const fetchComment = async () => {
            try {
              const res = await axios.get('http://192.168.0.200:8080/endpoint/message')
         ...
         useEffect(()=>{
            if (navigator.onLine) {
              const socket = io('http://192.168.0.200:8080')
          ...
          if (idEdit !== null) {
                   try {
                     const res = await axios.get(`http://192.168.0.200:8080/endpoint/get-message/${idEdit}`);
         ...
         const handleDeleteUpdate = async (e) => {
          e.preventDefault()
          try {
            const res = await axios.delete(`http://192.168.0.200:8080/endpoint/delete-message/${DeleteId}`);
            if (res) {
              setUpdateD('Delete')
              handleOpen();
                   }} 
         ...
         const handleSubmit =async (e)=>{
          ...
          const data = {
           ...
           try{
             const res = await axios.put(`http://192.168.0.200:8080/endpoint/update-message/${idEdit}`,data);
             if (res) {
              setUpdateD('true')
              handleOpen();
             }
         ...
         const handleSubmitEdit = async (e) => {
            ...
            try {
              const res = await axios.post('http://192.168.0.200:8080/endpoint/create-message/',data)
              if (res) {
                setUpdateD('saved')
                setMessage("");
                handleOpen();
