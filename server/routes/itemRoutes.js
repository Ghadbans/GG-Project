  ...
  try {
    ...
    if (!destinationItem) {
      ...
      destinationItem = new itemSchema({
        typeItem: sourceItem.typeItem || 'Goods',
        ...
        itemManufacturer: sourceItem.itemManufacturer || '',
        itemSellingPrice: sourceItem.itemSellingPrice || 0,
        itemCostPrice: sourceItem.itemCostPrice || 0,
