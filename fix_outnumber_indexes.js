...
const schemas = [
  {
    file: 'itemOutSchema.js',
    schemaName: 'itemOutSchema',
    field: 'outNumber'
  },
  {
    file: 'itemReturnSchema.js',
    schemaName: 'itemReturnSchema',
    field: 'outNumber'
  }
];
...
async function dropOldIndexes() {
  try {
    ...
    const collectionsToDropIndexes = [
      { coll: 'itemOut', index: 'outNumber_1' },
      { coll: 'itemReturn', index: 'outNumber_1' },
      { coll: 'itemout', index: 'outNumber_1' },
      { coll: 'itemreturn', index: 'outNumber_1' }
    ];
